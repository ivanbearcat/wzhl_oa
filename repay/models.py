...
class repay(models.Model):
    ...
    budget_class = models.CharField(verbose_name='预算类型', max_length=64, blank=False)
    budget_class_level2 = models.CharField(verbose_name='预算类型', max_length=64, blank=False)
    department = models.CharField(verbose_name='所属中心', max_length=32, blank=False)
    ...
    contract_uuid = models.CharField(verbose_name='合同编号', max_length=16, blank=False)
    final_payment_date = models.DateField(verbose_name='最终付款日', auto_now_add=False, blank=False)
