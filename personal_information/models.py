...
class table(models.Model):
    ...
    join_date = models.DateField(verbose_name='入职日期', auto_now_add=False, blank=True)
    ...
    years_of_working = models.CharField(verbose_name='工作年限', max_length=2, blank=False)
    ...
    platform = models.CharField(verbose_name='平台', max_length=30, blank=True)
    ...
    update_time = models.DateTimeField(verbose_name='更新日期', auto_now_add=False, blank=False)
